  ...
  return (
    <>
      <CoordinatorPageHero
        ...
        description="Plan, dispatch, and track relief supplies on their way to affected communities."
      />
      <RoleNavigation />
      <section
          ...
          <form className="resource-form panel" onSubmit={handleSubmit}>
            ...
            <label>
              ...
              <input
                ...
                onChange={(event) =>
                  setFormState({ ...formState, destination: event.target.value })
                }
            ...
            <label>
              ...
              <input
                ...
                onChange={(event) =>
                  setFormState({ ...formState, scheduledAt: event.target.value })
                }
              />
            </label>
            ...
            <button
              ...
              type="submit"
              disabled={isSaving || !selectedResource}
            >
              {isSaving ? (
