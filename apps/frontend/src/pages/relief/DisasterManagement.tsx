...
export function DisasterManagement() {
  const [disasters, setDisasters] =
    useState<DisasterRecord[]>([]);

  const [formState, setFormState] =
    useState<CreateDisasterInput>(
      initialFormState
    );
      ...
      <section className="top-band">
        <div className="top-band__content">
          <div>
            ...
            <p className="intro">
              Publish and maintain current
              disaster information so relief
              personnel and affected communities
              can access accurate emergency
              updates.
            </p>
          </div>
