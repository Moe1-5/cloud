import type { ActivityAction, ActivityLogRecord } from "@ddac/shared";
      ...
      <section className="top-band">
        <div className="top-band__content">
          <div>
            ...
            <p className="intro">
              Review important system actions including record creation, updates, status changes and
              deletions.
            </p>
          </div>
        ...
        <section className="project-list">
          ...
          {isLoading ? (
            ...
            <div className="empty-state">
              ...
              <p>Create, update or delete a system record and the activity will appear here.</p>
            </div>
          ) : (
