...
const roleDescriptions: Record<UserRole, string> = {
  admin:
    "Controls user accounts, permissions, organisations, activity logs and system reports.",
    ...
    <main className="app-shell">
      <section className="top-band">
        <div className="top-band__content">
          <div>
            ...
            <p className="intro">
              Review the permissions assigned to each
              system role and understand what areas of
              the Disaster Relief Coordination System
      ...
      >
        ...
        >
          ...
          >
            Roles are predefined for this system.
            Administrators assign one of these roles
            when creating or editing a user account.
          </p>
        </div>
